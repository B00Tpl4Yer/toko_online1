            ...
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                        @if ($orders->where('status', 'belum bayar')->count() > 0)
                            @foreach ($orders->where('status', 'belum bayar') as $order)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('operator.order.view_proof', $order) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">verifikasi pembayaran</a>
                                </td>
                            </tr>
                            @endforeach
                        @else
            ...
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                        @if ($orders->whereIn('status', ['menunggu pengiriman', 'barang dikirim'])->count() > 0)
                            @foreach ($orders->whereIn('status', ['menunggu pengiriman', 'barang dikirim']) as $order)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('operator.viewsend' , ['order' => $order]) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">verifikasi pengiriman</a>
                                </td>
                            </tr>
                            @endforeach
                        @else
            ...
            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="settings" role="tabpanel" aria-labelledby="settings-tab">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                        @if ($orders->where('status', 'barang diterima')->count() > 0)
                            @foreach ($orders->where('status', 'barang diterima') as $order)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('operator.order.view_proof', $order) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">lihat riwayat pesanan</a>
                                </td>
                            </tr>
                            @endforeach
                        @else
